...
params:
  ...
  suffix: "_v2" # "_v2" = updated (v2) climate processing; "" = original files
...
modDat <- readRDS( here("Data_processed", "CoverData", paste0("DataForModels_spatiallyAveraged_withSoils_noSf_sampledLANDFIRE", suffix, ".rds"))) %>% st_drop_geometry()
```
...
saveRDS(modDat_1_s_temp, file = paste0("./models/scaledModelInputData_yesNoTreeMod", suffix, ".rds"))
...
if (run == TRUE) {
  ...
  my_folds <- as.numeric(as.factor(train_eco))
    ...
    base::saveRDS(fit, paste0("../ModelFitting/models/ForestMod_globalLASSOmod_binomial_treeCutoff_",treeThreshold, suffix, ".rds"))
...
## fit using glm
  ...
  ## save models 
  saveRDS(fit_glm_bestLambda, paste0("./models/ForestMod_bestLambdaGLM_",treeThreshold, suffix, ".rds"))
  saveRDS(fit_glm_halfse, paste0("./models/ForestMod_halfSELambdaGLM_",treeThreshold, suffix, ".rds"))
  saveRDS(fit_glm_se, paste0("./models/ForestMod_oneSELambdaGLM_",treeThreshold, suffix, ".rds"))
  ...
  save(f_glm_halfse, mat_glmnet_halfse, halfseLambda_coef,
              ...
              file = paste0("./models/interimModelFittingObjects_ForestMod_binomial_",treeThreshold, suffix, ".rds"))
  } else {
    # read in LASSO object
    fit <- readRDS(paste0("../ModelFitting/models/ForestMod_globalLASSOmod_binomial_treeCutoff_",treeThreshold, suffix, ".rds"))
    
    # read in R objects having to do w/ model fitting 
    load(file = paste0("./models/interimModelFittingObjects_ForestMod_binomial_",treeThreshold, suffix, ".rds"))
      
  fit_glm_bestLambda <- readRDS(paste0("./models/ForestMod_bestLambdaGLM_",treeThreshold, suffix, ".rds"))
  fit_glm_halfse <- readRDS(paste0("./models/ForestMod_halfSELambdaGLM_",treeThreshold, suffix, ".rds"))
  fit_glm_se <- readRDS(paste0("./models/ForestMod_oneSELambdaGLM_",treeThreshold, suffix, ".rds"))
  }
...
climDat_Temp <- readRDS(paste0("../../../Data_processed/WallToWallClimateData/DayMetData_allCONUS_2023ClimateValues_withSoils", suffix, ".rds"))
...
saveRDS(best_threshold_bestLambda, paste0("./models/ForestModelPrevalence", suffix, ".rds"))
```
...
saveRDS(lowBuffProb, paste0("./models/ForestModel_interpLowerBuffer", suffix, ".rds"))
saveRDS(highBuffProb, paste0("./models/ForestModel_interpHigherBuffer", suffix, ".rds"))
```
...
saveRDS(modDat_treePreds, paste0("../../../Data_processed/CoverData/CoverModelData_withTreeNoTreePreds", suffix, ".rds"))
...
<!-- ```{r, eval = FALSE} -->
<!-- # get data -->
<!-- modDat_treePreds <- readRDS(paste0("../../../Data_processed/CoverData/CoverModelData_withTreeNoTreePreds", suffix, ".rds")) -->
